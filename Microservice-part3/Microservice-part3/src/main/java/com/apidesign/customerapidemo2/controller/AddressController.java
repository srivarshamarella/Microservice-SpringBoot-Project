...
//		@CrossOrigin("*")
//		@GetMapping("/customers/{customerId}/addresses/latestrecord")
//		public ResponseEntity<?> getLatestRecord(@PathVariable("customerId") long customerId)
//		{
//			if(this.addressService.getLatestRecord(customerId)!=null)
//				return ResponseEntity.ok(this.addressService.getLatestRecord(customerId));
//			else
//				return ResponseEntity.ok("Customer Not found, address cannot be fetched");
//		}
